...
|---|---|---|
| $n$ 年期定期寿险 | $A^1_{x:\overline{n}\vert}$ | $\bar A^1_{x:\overline{n}\vert}$ |
| 终身寿险 | $A_x$ | $\bar A_x$ |
| 延期 $m$ 年 $n$ 年期寿险 | ${}_{m\vert n}A_x$ | ${}_{m\vert n}\bar A_x$ |
| 延期 $m$ 年终身寿险 | ${}_{m\vert}A_x$ | ${}_{m\vert}\bar A_x$ |
| $n$ 年期生存保险 | ${}_nE_x$ | 生存给付在 $n$ 年末 |
| $n$ 年期生死合险 | $A_{x:\overline{n}\vert}$ | $\bar A_{x:\overline{n}\vert}$ |
...
| $n$ 年定期生存年金 | $\bar a_{x:\overline{n}\vert}$ | $\ddot a_{x:\overline{n}\vert}$ | $a_{x:\overline{n}\vert}$ |
| 延期 $m$ 年终身生存年金 | ${}_{m\vert}\bar a_x$ | ${}_{m\vert}\ddot a_x$ | ${}_{m\vert}a_x$ |
| 延期 $m$ 年、给付 $n$ 年生存年金 | ${}_{m\vert}\bar a_{x:\overline{n}\vert}$ | ${}_{m\vert}\ddot a_{x:\overline{n}\vert}$ | ${}_{m\vert}a_{x:\overline{n}\vert}$ |
...
|---|---|---|---|
| 定期寿险 | $\bar P(\bar A^1_{x:\overline{n}\vert})$ | $P(\bar A^1_{x:\overline{n}\vert})$ | $P^1_{x:\overline{n}\vert}$ |
| 终身寿险 | $\bar P(\bar A_x)$ | $P(\bar A_x)$ | $P_x$ |
| 两全保险 | $\bar P(\bar A_{x:\overline{n}\vert})$ | $P(\bar A_{x:\overline{n}\vert})$ | $P_{x:\overline{n}\vert}$ |
| 缴费期 $h$ 年终身寿险 | ${}_h\bar P(\bar A_x)$ | ${}_hP(\bar A_x)$ | ${}_hP_x$ |
| 缴费期 $h$ 年定期寿险 | ${}_h\bar P(\bar A^1_{x:\overline{n}\vert})$ | ${}_hP(\bar A^1_{x:\overline{n}\vert})$ | ${}_hP^1_{x:\overline{n}\vert}$ |
| 延期终身生存年金保费 | $\bar P({}_{m\vert}\bar a_x)$ | $P({}_{m\vert}\bar a_x)$ | $P({}_{m\vert}\ddot a_x)$ |
